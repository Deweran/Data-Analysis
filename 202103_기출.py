...
x_test = pd.read_csv('C:\\Users\\김이슬아\\Desktop\\python\\빅분기 실기 자료\\304_x_test.csv')
x_train = pd.read_csv('C:\\Users\\김이슬아\\Desktop\python\\빅분기 실기 자료\\304_x_train.csv')
y_train = pd.read_csv('C:\\Users\\김이슬아\\Desktop\python\\빅분기 실기 자료\\304_y_train.csv')
...
obj = ['Employment Type','GraduateOrNot','FrequentFlyer','EverTravelledAbroad']
y = ['TravelInsurance']
